...
set(tools /opt/cc-ubuntu-bionic-arm64/native-pi-gcc-10.3.0-64)
set(rootfs_dir /opt/cc-ubuntu-bionic-arm64/sysroot)
...
SET (CMAKE_C_COMPILER ${BIN_PREFIX}-gcc-10.3.0)
SET (CMAKE_CXX_COMPILER ${BIN_PREFIX}-g++-10.3.0 )
SET (CMAKE_LINKER ${BIN_PREFIX}-ld 
            CACHE STRING "Set the cross-compiler tool LD" FORCE)
SET (CMAKE_AR ${BIN_PREFIX}-gcc-ar-10.3.0 
