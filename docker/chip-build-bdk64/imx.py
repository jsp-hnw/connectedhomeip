...
class IMXBuilder(GnBuilder):
    ...
    def GnBuildArgs(self):
        ...
        args = [
            ...
            f'target_cc="{toolchain_root}/bin/aarch64-buildroot-linux-gnu-gcc"',
            f'target_cxx="{toolchain_root}/bin/aarch64-buildroot-linux-gnu-g++"',
            f'target_ar="{toolchain_root}/bin/aarch64-buildroot-linux-gnu-ar"',
        ]
