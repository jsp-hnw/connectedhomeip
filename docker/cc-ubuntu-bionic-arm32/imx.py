    ...
    def GnBuildArgs(self):
        ...
        args = [
            ...
            f'target_cflags=[\
                ...
                "-Wl,-rpath-link,{toolchain_sysroot}/usr/lib/arm-linux-gnueabihf/",\
                ]',
            f'target_ldflags=[\
                "-L{toolchain_sysroot}/lib/",\
                "-L{toolchain_sysroot}/lib/arm-linux-gnueabihf/",\
                "-L{toolchain_sysroot}/usr/lib/",\
                "-L{toolchain_sysroot}/usr/lib/arm-linux-gnueabihf/",\
                "-Wl,-rpath-link,{toolchain_sysroot}/lib/",\
                "-Wl,-rpath-link,{toolchain_sysroot}/lib/arm-linux-gnueabihf/",\
                "-Wl,-rpath-link,{toolchain_sysroot}/usr/lib/",\
                "-Wl,-rpath-link,{toolchain_sysroot}/usr/lib/arm-linux-gnueabihf/",\
                ]',
            f'target_cc="{toolchain_root}/bin/arm-linux-gnueabihf-gcc"',
            f'target_cxx="{toolchain_root}/bin/arm-linux-gnueabihf-g++"',
            f'target_ar="{toolchain_root}/bin/arm-linux-gnueabihf-ar"',
        ]
