...
class IMXBuilder(GnBuilder):
    ...
    def GnBuildArgs(self):
        ...
        sdk_target_sysroot = '/opt/qorvo/sysroot/'
        target_cpu = 'arm'
        arm_arch = 'armv7ve'
        args = [
            ...
            'target_cflags=["--sysroot=/opt/qorvo/sysroot/", "-I/opt/qorvo/sysroot/usr/include/arm-linux-gnueabihf/", "-I/opt/qorvo/sysroot/usr/include/", "-Wl,-rpath-link,/opt/qorvo/sysroot/usr/lib/arm-linux-gnueabihf/", "-L/opt/qorvo/sysroot/usr/lib/arm-linux-gnueabihf",]',
            'target_ldflags=["--sysroot=/opt/qorvo/sysroot/", "-Wl,-rpath-link,/opt/qorvo/sysroot/usr/lib/arm-linux-gnueabihf", "-L/opt/qorvo/sysroot/usr/lib/arm-linux-gnueabihf",]',
            'target_cc="/opt/qorvo/toolchain/cross-pi-gcc-8.3.0-1/bin/arm-linux-gnueabihf-gcc"',
            'target_cxx="/opt/qorvo/toolchain/cross-pi-gcc-8.3.0-1/bin/arm-linux-gnueabihf-g++"',
            'target_ar="/opt/qorvo/toolchain/cross-pi-gcc-8.3.0-1/bin/arm-linux-gnueabihf-ar"',
        ]
